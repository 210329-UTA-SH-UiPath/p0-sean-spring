...
namespace PizzaBox.Client
{
    ...
    {
        private static readonly string _connectionString = "Server=tcp:pizzabox-app.database.windows.net,1433;Initial Catalog=pizza-app;Persist Security Info=False;User ID=dev;Password=435s606S!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
